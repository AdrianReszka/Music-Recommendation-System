...
function LoadingOverlay({ visible, text = "Loading...", zIndex = 1200 }) {
    if (!visible) return null;

    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm" style={{ zIndex }}>
