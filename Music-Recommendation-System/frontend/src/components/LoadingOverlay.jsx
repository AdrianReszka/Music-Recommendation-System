...
export default  function LoadingOverlay({ visible, text = "Loading...", zIndex = 1200 }) {
    ...
    return (
        <div
            ...
            style={{ zIndex }}
        >
            <div className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-[#1f1f1f] shadow-xl">
                <div className="relative">
                    <div className="h-10 w-10 rounded-full border-4 border-gray-500 border-t-[#1DB954] animate-spin"></div>
